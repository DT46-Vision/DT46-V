...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                name="detector_params_infantry_file",
                default_value=detector_params_infantry_file,
            ),
            DeclareLaunchArgument(
                name="tracker_params_infantry_file",
                default_value=tracker_params_infantry_file,
            ),
            DeclareLaunchArgument(
                name="serial_params_file", default_value=serial_params_file
            ),
            DeclareLaunchArgument(
                name="dm_imu_params_file", default_value=dm_imu_params_file
            ),
            # ----------- 启动串口通信节点 -----------
            Node(
                package="rm_serial",
